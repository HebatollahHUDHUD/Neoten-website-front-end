...
export default function MissionVisionSection (){
    const items = [
    {
      ...
      title: "Our Vision",
      description: "To be a global leader in logistics and supply chain solutions, recognized for reliability, innovation, and excellence in connecting businesses worldwide.",
    },
    {
