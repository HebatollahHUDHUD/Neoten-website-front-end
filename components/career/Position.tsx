          ...
          {jobs.map((job) => (
            <SwiperSlide key={job.id}>
              <div className="p-6 h-full flex flex-col items-start">
                ...
                <p className="font-normal text-xs mt-2 mb-4 text-start">
